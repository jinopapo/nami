...
const getMessageText = (update: SessionUpdateEvent['update']): string | undefined => {
...
const toAssistantMessageChunkEvent = (event: SessionUpdateEvent): SessionEvent | undefined => {
...
const toAssistantMessageCompletedEvent = (event: TaskEvent): SessionEvent | undefined => {
